		...
		<div class="content">
			...
			<form method="post" action="updateOk">
				...
				<div>
					...
					<input type="text" name="title" id="title" value="${idto.title}" placeholder="제목을 입력하세요">
				</div>
				<div>
					<label for="content">문의 내용</label>
					<textarea name="content" id="content" maxlength="400" placeholder="문의 내용을 입력하세요" required>${idto.content}</textarea>
				</div>
				<div>
