...
<div class="inputContentsErrorMessage" style="color: red; font-size: 12px; margin-top:5px; visibility: visible; ">
											필수 선택 항목입니다.
										</div>
</div>
...
<input type="text" id="countryNumber" name="countryNumber" required readonly>
<div class="inputContentsErrorMessage" style="color: red; font-size: 12px; margin-top:5px; visibility: visible; ">
											필수 입력 항목입니다.
										</div>
</div>
...
<input type="text" id="email" name="eamil" required>
</div>
</div>
