	...
	<div class="passportInfo">
		...
		<input type="hidden" name="pnr" value="${pnr}"/>
			...
			<div class="contents_agreement">
				...
				<p>미국 교통보안청(TSA)의 요청에 따라 정보개인 및 테러지원자명단에 근거하여 승객의 개인정보(성명, 국적, 생년월일, 여권번호, 발급국가, 만료일 등)를 제공하게 됩니다. 제공 정보는 미국의 Watch List(경계인물명단)와의 비교를 위해 사용되며, 미국 사법기관 또는 타 정부기관과 공유될 수 있습니다.</p>
